...
function PuzzleListItem({ puzzleNum }: { puzzleNum: number }) {
  ...
  return (
    <Link 
      ...
      className='grid grid-cols-2 col-span-full justify-between items-center w-full py-4  hover:bg-neutral-300 hover:pl-3 transition-all duration-500 text-sm sm:text-base'
    >
